...
class TestDraftDecodeMask(CustomTestCase):
    def test_build_tree_kernel_efficient(self):
        ...
        try:
            ...
            print("✗ Tree Mask assertion failed!")
        ...
        try:
            ...
            print("✗ Position assertion failed!")
        ...
        try:
            self.assertEqual(actual_retrive_index, expected_retrive_index)
            print("✓ Retrive_index matches!")
        except AssertionError as e:
            print("✗ Retrive_index assertion failed!")
        ...
        try:
            self.assertEqual(actual_retrive_next_token, expected_retrive_next_token)
            print("✓ Retrive_next_token matches!")
        except AssertionError as e:
            print("✗ Retrive_next_token assertion failed!")
        ...
        try:
            self.assertEqual(actual_retrive_next_sibling, expected_retrive_next_sibling)
            print("✓ Retrive_next_sibling matches!")
        except AssertionError as e:
            print("✗ Retrive_next_sibling assertion failed!")
        ...
        try:
            self.assertEqual(actual_draft_tokens, expected_draft_tokens)
            print("✓ Draft_tokens matches PyTorch implementation!")
        except AssertionError as e:
            print("✗ Draft_tokens assertion failed!")
    ...
    def test_build_tree_preprocess(self):
    ...
    def test_build_tree_simple_case(self):
